...
<head>
	...
	<style>
		...
		aside#aside li { font-size:16px; text-align:center; position:relative; }
		...
		#userAddr2 { width:600px; }	
		#userAddr3 { width:600px; }	
	</style>
		...
		<div id="container_box">
			...
			<div class="orderInfo">
				<form role="form" method="post" autocomplete="off">
  					...
  					<div class="inputArea">
   						<label for="">수령인</label>
   						<input type="text" name="orderRec" id="orderRec" required="required" placeholder="수령인" />
  					</div>
					<div class="inputArea">
   						<label for="orderPhone">수령인 연락처</label>
   						<input type="text" name="orderPhone" id="orderPhone" required="required" placeholder="수령인 연락처" />
					</div>
					<div class="inputArea">
						<p>
							<input type="text" name="userAddr1" id="userAddr1" required="required" placeholder="우편번호" readonly size="4" />
							&ensp;
							<input type="button" onclick="openChild()" value="도로명주소 검색" />
						</p>
						    <script>
								function openChild(){
									// window.name="부모창 이름";
									window.name="carList";
									// window.open("open할 window", "자식창 이름", "팝업창 옵션들");
									window.open("searchAddr", "searchAddr", "menubar=no , width=720, height=350");
								}
							</script>
						<p>
							<input type="text" name="userAddr2" id="userAddr2" required="required" placeholder="도로명주소" readonly />
						</p>
						<p>
							<input type="text" name="userAddr3" id="userAddr3" required="required" placeholder="상세주소" />
						</p>
